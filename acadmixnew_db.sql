...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/06/2025 às 15:31
...
(1, 'contas daoras', 'fazer contas', 4, 1, 4, '2025-06-10 12:31:01', '2025-06-11 09:30:00', 'uploads/tarefas/professor/1749558661_Briefing - trabalho.docx');
...
--
-- Despejando dados para a tabela `tarefas_submissoes`
--

INSERT INTO `tarefas_submissoes` (`id`, `tarefa_id`, `aluno_id`, `data_submissao`, `arquivo_path_aluno`, `nota`, `feedback_professor`, `data_avaliacao`) VALUES
(1, 1, 6, '2025-06-10 13:13:11', 'uploads/tarefas/aluno/aluno6_tarefa1_1749561191.docx', NULL, NULL, NULL);
